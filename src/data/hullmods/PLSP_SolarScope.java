...
public class PLSP_SolarScope extends BaseHullMod {
	...
	public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
		...
		tooltip.addPara("%s " + strings.get("solarscopeTEXT1"), pad, Misc.getPositiveHighlightColor(), "#", Global.getSettings().getHullModSpec("PLSP_solarscope").getDisplayName(), "2%", "3%", "4%", "5%");
		tooltip.addPara("%s " + strings.get("solarscopeTEXT2"), padS, Misc.getHighlightColor(), "#", "30%");
